              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex w-full items-center gap-3 rounded-2xl border border-cyan-100 bg-white/75 px-3 py-2.5">
                      ...
                      <span className="min-w-0 text-xs text-slate-700 sm:text-sm leading-snug">
                        <span className="block">goodwill2404</span>
                    ...
                    <div className="flex w-full items-center gap-3 rounded-2xl border border-cyan-100 bg-white/75 px-3 py-2.5">
                      ...
                      <span className="min-w-0 text-xs text-slate-700 sm:text-sm leading-snug">
                        ...
                        <span className="block">9691569239</span>
                      </span>
                    </div>
                    <div className="flex w-full items-center gap-3 rounded-2xl border border-cyan-100 bg-white/75 px-3 py-2.5">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-cyan-100">
